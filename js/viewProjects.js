...
export default function buildCard(cardProject, title, description, urlGit, urlSite) {
          ...
          <div class="card__descr-wrapper">
              ...
              <div class="card__links">
                  <div>
                      ...
                      <a class="link" href="${urlSite}">Preview</a>
                  </div>
                  <div>
                      ...
                      <a class="link" href="${urlGit}">Code</a>
                  </div>
              </div>
          </div>
      </div>`;
...
async function listProjects() {
  const projectsApi = await conectApi.listProjects();
  projectsApi.forEach(element => {
      const cardProject = document.createElement('div');
      cardProject.setAttribute('class', 'card');
      cards.appendChild(cardProject);
      buildCard(cardProject, element.title, element.description, element.urlGit, element.urlSite);
  });
}
